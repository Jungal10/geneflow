...
topwindows<- fread("/Users/josedias/Desktop/top_comvbined_windows_caudatus.txt") %>%
  mutate(windowsize=
           windowStart) %>%
  mutate(height=1) 
...
sweeps_caudatus.df<- sweeps_caudatus.df %>%
  ...
  # mutate(window_center=windowCenter/1e6) %>%
        ...
        ggsave("/Users/josedias/Documents/PhD/projects/GeneFlow/text/amaranth_introgression/figures/fdM_sweeps_cau_hyp_cru_cb_full_genome.png", plot_fd_crops, bg='white', width=20, height = 5, dpi = 600)
                ggsave("/Users/josedias/Documents/PhD/projects/GeneFlow/text/amaranth_introgression/figures/fdM_sweeps_cau_hyp_cru_cb_full_genome.pdf", plot_fd_crops, bg='white', width=20, height = 5, dpi = 600)
...
```{r}
phyper(57416, 7504264, 410621399, 9)

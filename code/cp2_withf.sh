...
#SBATCH --error /scratch/jgoncal1/logs/errors/cp2_sc9_15_%j.error
#SBATCH -o /scratch/jgoncal1/logs/cp2_sc9_15_%j.log
#SBATCH -D /projects/ag-stetter/jdias/projects/geneflow/code/
#SBATCH --job-name="cp2_sc9_15_" #a nice readable name to give your job so you know what it is when you see it in the queue, instead of just numbers

...
#SBATCH -o /scratch/asingh3/Fastsimcoal2/MODELSlogs/Fastsimcoal-4popSplit-Log-%j.txt
#SBATCH -e /scratch/asingh3/Fastsimcoal2/MODELS/logs/Fastsimcoal-4popSplit-Log-%j.err
#SBATCH -t 2-12:00:00
#SBATCH -J 4pop-Split
